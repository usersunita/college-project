...
const RegisterForm = ({ formData, formType, onSubmit, onChange, handlePhotoChange }) => {
  ...
  return (
    <form onSubmit={onSubmit}>
      <input type="text" name="firstName" value={firstName || ''} onChange={onChange} placeholder="First Name" className="form-input" /><br />
      <input type="text" name="lastName" value={lastName || ''} onChange={onChange} placeholder="Last Name" className="form-input" /><br />
      <input type="email" name="email" value={email || ''} onChange={onChange} placeholder="Email" className="form-input" /><br />
      <input type="password" name="password" value={password || ''} onChange={onChange} placeholder="Password" className="form-input" /><br />
      <input type="tel" name="phonenumber" value={phonenumber || ''} onChange={onChange} placeholder="Phone Number" className="form-input" /><br />
      <input type="hidden" name="formType" value={formType} />

      {formType === 'Guide' && (
        <>
          <input type="text" name="qualification" value={qualification || ''} onChange={onChange} placeholder="Qualification" className="form-input" /><br />
          <input type="text" name="experience" value={experience || ''} onChange={onChange} placeholder="Experience" className="form-input" /><br />
          <input type="file" className="form-control" id="photo" name="photo" accept="image/*" onChange={handlePhotoChange} />
        </>
      )}
